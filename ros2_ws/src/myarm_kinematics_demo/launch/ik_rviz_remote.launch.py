"""Run the complete IK/FK-to-TF demo on the Jetson."""
...
def generate_launch_description():
    ...
    kinematics_share = Path(get_package_share_directory("myarm_kinematics_demo"))
    robot_description = (
    ...
    return LaunchDescription([
        ...
        Node(
            package="myarm_kinematics_demo",
            executable="kinematics_node",
            name="myarm_kinematics",
            parameters=[kinematics_share / "config" / "kinematics.yaml"],
            output="screen",
        ),
        Node(
